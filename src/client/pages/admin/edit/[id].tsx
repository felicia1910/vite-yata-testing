...
const EditOrder = () => {
  ...
  return (
    <>
      ...
      <div
        className={`flex flex-col mb-8 text-lg lg:items-start justify-start lg:w-full ${
          showCalendar && "bg-[#F2F2F2]"
        }`}
      >
        <div
          className={`flex items-start justify-start lg:w-[80%] px-5 space-x-1 lg:px-0 lg:mt-5 lg:whitespace-nowrap  text-base ${
            showCalendar ? "lg:ml-[10%]" : "lg:ml-[9%]"
          } `}
        >
          <div className='flex items-center justify-start'>
            ...
            />
            <span
              className='ml-3 font-bold min-w-fit lg:ml-8'
